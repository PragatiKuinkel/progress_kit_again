...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $checkSql = "SELECT id FROM users WHERE id = :id AND full_name = :fullName AND email = :email";
        $checkQuery = $dbh->prepare($checkSql);
        $checkQuery->bindParam(':id', $adminId, PDO::PARAM_INT);
        $checkQuery->bindParam(':fullName', $fullName, PDO::PARAM_STR);
                    ...
                    <form id="profileForm" class="profile-form needs-validation" novalidate>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fullName" name="fullName" 
                                   value="<?php echo isset($profile['full_name']) ? htmlspecialchars($profile['full_name']) : ''; ?>" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="email" class="form-control" id="email" name="email" 
                                       value="<?php echo isset($profile['email']) ? htmlspecialchars($profile['email']) : ''; ?>" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="role" 
                                   value="<?php echo isset($profile['role']) ? htmlspecialchars($profile['role']) : 'user'; ?>" readonly>
                        </div>
