...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $query->bindParam(':id', $superuserId, PDO::PARAM_INT);
...
try {
    ...
    $sql = "SELECT full_name, email, phone FROM users WHERE id = :id";
    $query = $dbh->prepare($sql);
...
<body class="light-mode">
                ...
                <div class="card-body">
                    ...
                    <form id="profileForm" class="profile-form needs-validation" novalidate>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fullName" name="fullName" value="Pratyush Kuinkel" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="email" class="form-control" id="email" name="email" value="pratyushkuinkel@gmail.com" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" value="9898899899">
                        </div>

                        <div class="form-group">
                            <label for="role" class="form-label">Role</label>
                            <input type="text" class="form-control" id="role" value="super_user" readonly>
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            additionalEmailInput.addEventListener('input', function(e) {
                const email = e.target.value;
                if (email) {
                    const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
                    if (!emailRegex.test(email)) {
                        additionalEmailInput.setCustomValidity('Please enter a valid email address');
                    } else {
