        ...
        <div class="messages-container">
            <div class="messages-area" id="messagesContainer">
                <?php foreach ($messages as $message): ?>
                    <div class="message <?php echo $message['sender_role'] === 'superuser' ? 'admin' : ($message['sender_role'] === 'admin' ? 'admin' : 'user'); ?>">
...
$(document).ready(function() {
    ...
    function appendMessage(message, formattedTime) {
        const messageHtml = `
            <div class="message ${message.sender_role === 'superuser' ? 'admin' : (message.sender_role === 'admin' ? 'admin' : 'user')}">
                <div class="message-header">
                    <div class="sender-info">
